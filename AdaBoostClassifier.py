...
predict_file = "../1_评价指标(含接口数据)/statistic_media_predict.txt"
true_file = "../1_评价指标(含接口数据)/statistic_media_true.txt"
main(predict_file,true_file)
#confMatrix = [[90,11],[8,91]]
#label2idx = {'1':0,'2':1}
#main(confMatrix,label2idx)